...
func SendIbcFundsTx(
	...
	call, err := gstypes.NewCall(meta, "Ibc.transfer", raw, size, to, channel, timeout, timestamp, height, assetId, amount2)
	if err != nil {
		return hash, err
	}
...
func MintFundsTx(
	...
	assetNum, err := strconv.ParseUint(amount.Denom, 10, 64)
	if err != nil {
		return hash, err
	}
	...
	assetId := gstypes.NewUCompactFromUInt(assetNum)
