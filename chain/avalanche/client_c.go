...
func (cchain *CChainClient) GetBalance(ctx context.Context, address string) (int64, error) {
	panic("not implemented")
}

func (cchain *CChainClient) GetBankBalance(ctx context.Context, bank, address, denom string) (int64, error) {
	//TODO implement me
	panic("implement me")
}
