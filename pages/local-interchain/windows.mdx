...
- Execute binary commands such as `tx decode` *[see example](https://github.com/strangelove-ventures/interchaintest/blob/main/local-interchain/python/api_test.py)*.
- Store and execute wasm smart contracts *[see example](https://github.com/strangelove-ventures/interchaintest/blob/main/local-interchain/python/daodao.py)*.
