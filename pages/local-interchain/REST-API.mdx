...
**NOTE** Action values may change in the future. Refer to [the API handler](https://github.com/strangelove-ventures/interchaintest/blob/main/local-interchain/interchain/handlers/actions.go) for the latest options.
...
The following examples use the [chains/base.json](https://github.com/strangelove-ventures/interchaintest/blob/main/local-interchain/chains/base.json) chain example (`local-ic start base`)
...
A full Python client can be found in the [scripts folder](https://github.com/strangelove-ventures/interchaintest/tree/main/scripts). This is just a snippet of code for example purposes.
