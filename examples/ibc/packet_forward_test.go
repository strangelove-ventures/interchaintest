...
func TestPacketForwardMiddleware(t *testing.T) {
	...
	cf := ibctest.NewBuiltinChainFactory(zaptest.NewLogger(t), []*ibctest.ChainSpec{
		{Name: "gaia", Version: "strangelove-forward_middleware_atomic", ChainConfig: ibc.ChainConfig{ChainID: chainID_A, GasPrices: "0.0uatom"}},
		{Name: "gaia", Version: "strangelove-forward_middleware_atomic", ChainConfig: ibc.ChainConfig{ChainID: chainID_B, GasPrices: "0.0uatom"}},
		{Name: "gaia", Version: "strangelove-forward_middleware_atomic", ChainConfig: ibc.ChainConfig{ChainID: chainID_C, GasPrices: "0.0uatom"}},
		{Name: "gaia", Version: "strangelove-forward_middleware_atomic", ChainConfig: ibc.ChainConfig{ChainID: chainID_D, GasPrices: "0.0uatom"}},
	})
