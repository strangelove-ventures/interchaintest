...
- Execute binary commands such as `tx decode` *[see example]([../local-interchain/python/api_test.py))*.
- Store and execute wasm smart contracts *[see example](../local-interchain/python/daodao.py)*.
