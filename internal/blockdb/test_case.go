...
// TestCase is a single testutil invocation.
type TestCase struct {
	db *sql.DB
	id int64
}

// CreateTestCase starts tracking new testutil case with testName.
...
// AddChain tracks and attaches a chain to the testutil case.
// The chainID must be unique per testutil case. E.g. osmosis-1001, cosmos-1004
