...
require (
	...
	github.com/quasar-finance/interchain-query-demo v0.0.0-20220824074743-1e1624a0a9a4 // indirect
...
replace github.com/cosmos/ibc-go/v3 => github.com/strangelove-ventures/ibc-go/v3 v3.0.0-20220622152118-86a199c7a516
