...
func TestParseHermesConfig(t *testing.T) {
	doc :=
	...
	require.Equal(t, cfg.Global.LogLevel, "info")
	require.Equal(t, cfg.Chains[0].ID, "ibc-0")
	require.Equal(t, cfg.Chains[1].ID, "ibc-1")
}
